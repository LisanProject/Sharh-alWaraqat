...
\urlstyle{same}
\hypersetup{
  pdftitle={Course Introduction, Note-Taking Tips, and Biographies of the Authors},
  pdfauthor={L.A. Hussein},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{Course Introduction, Note-Taking Tips, and Biographies of the
Authors}
\author{L.A. Hussein}
\date{2025-12-25}
\begin{document}
...
\href{https://www.instagram.com/abdullahishire_/?hl=en}{\textbf{Sheikh
Abdullahi Shire}} of
\href{https://www.instagram.com/miraathinstitute/?hl=en}{\textbf{Miraath
Institute}}.

For those interested in learning more about the life of Imam al-Shafi'i
and the historical development of the madhhab, please refer to
\href{https://lisanproject.github.io/FiqhalManhaji/course-material.html}{\textbf{this
resource}}.
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, opacityback=0, breakable, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Before the Lesson}, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white, coltitle=black]
...
\item
  ...
  learned after class.
\item
  Before class, \textbf{recite Qur'an abundantly} and \textbf{send
  abundant salawat upon the Prophet ﷺ}, intending that Allah opens
  understanding and blesses your lesson.
\end{itemize}

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, opacityback=0, breakable, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Reflections from the Scholars}, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white, coltitle=black]

Some people said to the scholar of Damascus \textbf{Shaykh Ali
al-Daqqar}:\\
\textgreater{} ``We deliver various lessons to the people but we do not
see in them the same effect that we notice in your lessons.''

He replied:\\
\textgreater{} ``My son --- were it not for necessity I would not speak.
This lesson you are hearing, my son, is supported by the recitation of
ten ajza' (parts) of the Qur'an before dawn with the intention that
Allah benefits the Muslims through what I speak about.''

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\textbf{Al-Haafidh al-Diyaa' al-Maqdisi} said:\\
\textgreater{} ``Ibrahim ibn `Abdil-Wahid al-Maqdisi advised me at the
time I traveled for seeking knowledge: `Increase in recitation of the
Qur'an and do not leave it. For indeed whatever you seek will be
facilitated for you proportionate to what you recite.'\,''

He added:\\
\textgreater{} ``I saw that and experienced it many times. When I
recited a great deal of Qur'an, listening to Hadith and writing much of
it down became easy for me. But when I did not recite, it was not
facilitated.''
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, opacityback=0, breakable, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Source}, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white, coltitle=black]
...
\tightlist
\item
  \textbf{Grandfather:} Yusuf ibn Abd Allah, a distinguished
  literatus.\\
\item
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, opacityback=0, breakable, toptitle=1mm, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Praise for His Students}, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, titlerule=0mm, toprule=.15mm, opacityback=0, breakable, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Praise from Scholars}, arc=.35mm, bottomtitle=1mm, leftrule=.75mm, opacitybacktitle=0.6, colback=white, coltitle=black]
